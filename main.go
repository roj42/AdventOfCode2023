...
func main() {
	...
	case "12":
		fmt.Println(day12(scanner, false))
	case "12_2":
		fmt.Println(day12(scanner, true))
	case "13":
		fmt.Println(day13(scanner, false))
	case "13_2":
		fmt.Println(day13(scanner, true))
	case "14":
	...
	case "16":
		fmt.Println(day16(scanner, false))
	case "16_2":
		fmt.Println(day16(scanner, true))
	default:
